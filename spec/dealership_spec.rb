...
RSpec.describe Dealership do
  ...
  it 'checks if specific dealership has inventory' do
    dealership = Dealership.new("Acme Auto", "123 Main Street")
    car_1 = Car.new("Ford Mustang", 1500, 36)
    car_2 = Car.new("Toyota Prius", 1000, 48)
  ...
  it 'sorts cars by make' do
    ...
    expect(dealership.cars_by_make("Toyota")).to eq(["Toyota Prius", "Toyota Tercel"])
    expect(dealership.cars_by_make("Ford")).to eq(["Ford Mustang"])
  end

  it 'checks total value of dealership' do
    dealership = Dealership.new("Acme Auto", "123 Main Street")
    car_1 = Car.new("Ford Mustang", 1500, 36)
    car_2 = Car.new("Toyota Prius", 1000, 48)
    car_3 = Car.new("Toyota Tercel", 500, 48)
